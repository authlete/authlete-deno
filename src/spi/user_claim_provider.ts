...
export interface UserClaimProvider
{
     ...
     *     Constant values that represent the standard claims are listed
     ...
     *     for details.
     *
     * @return The value of the claim. `null` if the value is not available.
     *         In most cases, a string should be returned. When `claimName`
     *         is `"address"`, an instance of `Address` class should be
     *         returned.
     */
